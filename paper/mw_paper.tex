...
I analyze three MW events: Event A (S/750$\to$S/850, May 2016), Event B (S/850$\to$S/930, April 2018), and Event C (S/930$\to$S/1,025, May 2022). Using ENAHO household survey data from 2015--2023, I find bunching ratios of 0.70--0.83, stable across aligned bin widths (S/10--S/25) and confirmed on EPE Lima quarterly data. Employment effects cannot be identified: event-study pre-trends fail, the Kaitz IV is weak ($F < 3$), and panel attrition exceeds 76\%. Confidence intervals, placebo tests, and identification diagnostics are reported in Section~\ref{sec:results}. This paper extends previous work on Peru's labor market \citep{jaramillo2004, cespedes2006, cespedes2014, jaramillo2012, chavez2024ethnic, chavez2023dv} by introducing a distributional estimator that quantifies redistribution separately from employment effects---a distinction that regression-based approaches cannot make in a single-national-MW setting.
