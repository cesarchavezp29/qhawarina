...
\paragraph{Organizing question.} Do subgroups with higher MW exposure (lower wages, smaller firms, weaker enforcement) show systematically different bunching ratios? If enforcement drives compliance, we would expect larger firms and Lima (higher SUNAFIL presence) to show higher ratios. If market adjustment dominates, ratios should be similar across groups.
...
The evidence is mixed. The private sector absorbs MW increases more effectively than the public sector (0.832 vs.\ 0.747), consistent with market adjustment rather than enforcement-driven compliance. Lima shows a higher ratio than the rest of the country in Event B (1.050 vs.\ 0.621), consistent with enforcement, but the pattern reverses in Events A and C. The Lima divergence in Event B remains unexplained. Lima's higher ratio in the smallest proportional increase (9.4\%) is inconsistent with a simple ``smaller bite is easier to absorb'' story---Lima's ratio is \emph{lower} than the national average in Event A (0.618), which had a larger bite (13.3\%). This inconsistency may reflect idiosyncratic shocks to Lima's labor market in 2017--2019 (e.g., construction boom, Venezuelan migration) that are orthogonal to the MW policy. We flag this as unresolved. The absence of a consistent enforcement gradient across all events suggests that formal-sector MW compliance in Peru operates through labor market adjustment---firms that choose to formalize have already internalized the MW floor---rather than through inspection-driven enforcement. Manufacturing consistently shows the highest ratios ($\approx 0.97$); micro firms show higher ratios than large firms in Events A--B, the opposite of an enforcement prediction, consistent with the self-selection story. No subgroup shows dramatically different behavior overall.

\paragraph{Interpretation caveat.}\footnote{We also examined heterogeneity by ethnicity. Among formal dependent workers, indigenous (Quechua/Aymara) and non-indigenous workers have similar wage distributions (both median S/1,400) and MW exposure (8.5\% vs.\ 10.7\% below MW). Bunching ratios by ethnicity are unstable across events (indigenous average 1.27, range 0.63--1.80) and reflect sector composition (59\% public sector) rather than differential MW compliance. The ethnic divide operates through access to formal employment: the indigenous formality rate is 5.7\% vs.\ 20.7\% for Spanish speakers \citep[see][]{chavez2024ethnic}.} The heterogeneity analysis is descriptive, not structural. There is no exogenous variation in enforcement intensity or sector-specific MW exposure to identify why ratios differ across subgroups. The firm-size pattern (micro $>$ large in Events A--B) is inconsistent with a pure enforcement story and may reflect self-selection: micro firms that choose to formalize have already internalized compliance costs, so the marginal micro formal firm is already a high-compliance unit. The public/private gap (0.75 vs.\ 0.83) likely reflects institutional rigidity in government pay scales rather than differential MW responsiveness. These interpretations are suggestive, not causal.
...
\paragraph{Policy implications.} Peru's MW increases over 2016--2022 operated within a Kaitz range of 0.52--0.57, where the evidence supports effective redistribution: 70--83\% of affected formal workers received raises, hours did not adjust, and the lighthouse evidence suggests some informal workers benefited as well. The cost was borne through institutional reallocation: some workers transitioned from formal dependent employment to informal self-employment, losing social security coverage while retaining employment and income at similar levels. Future MW adjustments that push the Kaitz index significantly above 0.60---as the 2025 increase to S/1,130 may do---enter territory where the balance between redistribution and displacement could shift, though our evidence cannot predict the threshold at which this occurs.
