...
The evidence is mixed. The private sector absorbs MW increases more effectively than the public sector (0.832 vs.\ 0.747), consistent with market adjustment rather than enforcement-driven compliance. Lima shows a higher ratio than the rest of the country in Event B (1.050 vs.\ 0.621), consistent with enforcement, but the pattern reverses in Events A and C. The absence of a consistent enforcement gradient suggests that formal-sector MW compliance in Peru operates through labor market adjustment---firms that choose to formalize have already internalized the MW floor---rather than through inspection-driven enforcement. Manufacturing consistently shows the highest ratios ($\approx 0.97$); micro firms show higher ratios than large firms in Events A--B, the opposite of an enforcement prediction, consistent with the self-selection story. No subgroup shows dramatically different behavior overall.
...
\paragraph{Ethnicity.} A natural question is whether MW increases differentially affect indigenous workers, who face higher barriers to formal employment. Building on \citet{chavez2024ethnic}, who finds that MW increases benefit Andean workers in the lowest income brackets and help close the ethnic wage gap, the present analysis documents the underlying mechanism: the ethnic divide operates through differential access to formal employment (5.7\% vs.\ 20.7\% formality rate), not through differential wages within the formal sector. Among formal dependent workers, indigenous (Quechua/Aymara/native-language) and non-indigenous workers have similar wage distributions (both median S/1,400) and similar MW exposure (8.5\% vs.\ 10.7\% below MW). The 925 indigenous formal dependent workers are predominantly public-sector employees (59\%), concentrated in highland departments. Bunching ratios by ethnicity are unstable across events and reflect sector composition rather than differential MW compliance.
