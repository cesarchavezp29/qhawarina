...
Daily EMBIG data for Peru is not publicly accessible via the BCRP API (all daily spread series return HTTP~403 as of March~2026). Monthly EMBIG averages from BCRP publications show broad co-movement with IRP/IRE spikes in October~2025 and March~2026, consistent with the indices, but a formal correlation analysis awaits daily data access.
