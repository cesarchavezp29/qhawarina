...
\begin{tabular}{lrrrrrr}
\toprule
Event & Date & IRP\,$\pm$1d & IRP\,$\pm$3d & IRE\,$\pm$3d & Abnormal IRP & $p$-value \\
\midrule
...
Castillo Condenado     & 2025-11-13 &  64.1 &  44.8 &  44.2 & $-25.5$ & $>0.999$ \\
...
\midrule
Non-event baseline & --- & --- & 70.3 & 54.6 & 0.0 & --- \\
\bottomrule
\multicolumn{7}{l}{\footnotesize Abnormal IRP = window $\pm$3d mean minus non-event mean (70.3). Non-event: $N = 320$ days.} \\
\multicolumn{7}{l}{\footnotesize $p$-value: one-sided Welch $t$-test, event window $\pm$5d vs.\ non-event days.} \\
\multicolumn{7}{l}{\footnotesize $^{*}p<0.10$, $^{**}p<0.05$. ``$>0.999$'': one-sided $p$-value rounds to 1.000 because the event-window} \\
\multicolumn{7}{l}{\footnotesize mean falls \emph{below} the non-event baseline, so the one-sided test is in the wrong tail.}
\end{tabular}
\end{table}
