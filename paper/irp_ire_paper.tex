...
($p = 0.168$; 14 observations).  Though not statistically significant at
conventional thresholds given only 14 months of data, the magnitude is
...
Vacancia Boluarte      & 2025-10-22 & 110.5 &  72.4 &  70.0 &  $+2.1$ & $>0.999$ \\
Castillo Condenado     & 2025-11-13 &  64.1 &  44.8 &  44.2 & $-25.5$ & $>0.999$$^\dagger$ \\
Censura Jeri           & 2026-01-21 & 161.2 & 115.5 &  49.4 & $+45.2$ & $0.093^{*}$ \\
...
should not predict future FX moves.  The short sample (63 weeks) also
limits statistical power; with 4--5 years of weekly data, the test would
be substantially more powerful.  These results should be interpreted as
descriptive rather than causal, in line with the measurement focus of this
paper.
...
controlling for concurrent economic disruption (IRE).
