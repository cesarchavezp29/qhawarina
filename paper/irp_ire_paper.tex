...
Daily EMBIG Peru data---the JP~Morgan Emerging Market Bond Index spread
for Peru, a market-based sovereign risk measure---is not currently
accessible via the BCRP public API.  The BCRP publishes monthly averages;
based on those, EMBIG Peru averaged approximately 120--130 basis points
throughout 2025, with modest widening in October--November 2025 (coinciding
with the transporters' strike and Castillo sentencing) and again in
March~2026 (Camisea energy crisis).  This broad co-movement is consistent
with our indices.  A formal daily EMBIG correlation analysis is deferred
to future work as access to the daily series expands.
