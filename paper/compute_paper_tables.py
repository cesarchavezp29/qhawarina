...
GDP_CI90_LO = [0.000, -1.287, -0.946, -0.702, -0.520, -0.387, -0.285, -0.207, -0.147]
GDP_CI90_HI = [0.000,  0.903,  0.438,  0.298,  0.189,  0.130,  0.090,  0.064,  0.045]
GDP_CI68_LO = [0.000, -0.768, -0.623, -0.474, -0.355, -0.255, -0.178, -0.126, -0.089]
GDP_CI68_HI = [0.000,  0.471,  0.131,  0.072,  0.033,  0.012,  0.006,  0.004,  0.003]

CPI_POINT   = [0.000,  0.380,  0.270,  0.206,  0.152,  0.109,  0.077,  0.054,  0.038]
CPI_CI90_LO = [0.000,  0.104,  0.056,  0.031,  0.013,  0.006,  0.001,  0.000, -0.001]
CPI_CI90_HI = [0.000,  0.614,  0.407,  0.336,  0.261,  0.205,  0.160,  0.126,  0.100]
CPI_CI68_LO = [0.000,  0.215,  0.121,  0.082,  0.048,  0.028,  0.016,  0.008,  0.004]
CPI_CI68_HI = [0.000,  0.513,  0.336,  0.271,  0.204,  0.153,  0.112,  0.081,  0.061]

FX_POINT    = [0.000, -0.210, -0.139, -0.019,  0.038,  0.051,  0.046,  0.037,  0.028]
FX_CI90_LO  = [0.000, -1.100, -0.948, -0.616, -0.393, -0.269, -0.188, -0.132, -0.091]
FX_CI90_HI  = [0.000,  0.680,  0.664,  0.586,  0.459,  0.358,  0.265,  0.188,  0.136]
FX_CI68_LO  = [0.000, -0.734, -0.608, -0.375, -0.216, -0.128, -0.080, -0.051, -0.033]
FX_CI68_HI  = [0.000,  0.334,  0.378,  0.354,  0.293,  0.215,  0.156,  0.110,  0.075]
